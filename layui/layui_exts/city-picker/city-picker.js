    ...
    CityPicker.prototype = {
        ...
        render: function () {
            var p = this.getPosition(),
                ...
                textspan = '<span class="city-picker-span" style="margin-right:10px;' 
                // +
                    ...
                    +
                    '<span class="title"></span><div class="arrow"></div>' + '<i style="display:none" class="icon_ca"></i></span>'
                    ,

                dropdown = '<div class="city-picker-dropdown" style="left:0px;top:36px;' +
        ...
        getWidthStyle: function (w, dropdown) {
            if (this.options.responsive && !$.isNumeric(w)) {
                ...
                return 'width:' + (dropdown ? Math.max(520, w) : w) + 'px;';
            }
        },
                ...
                .each(function () {
                    ...
                    if (item) {
                        text += ($(this).hasClass('province') ? '' : '/') + '<span class="select-item" data-count="' +
                            type + '" data-code="' + item.code + '">' + item.address + '</span><input type="hidden"' +
                            // id="' + type + '"
                            'name="' + type + '" value="' + item.code + '"  />';
                    }
                });
            return text;
        },
